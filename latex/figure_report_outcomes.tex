...
All-predictors: Condition RF AUC 0.730 ± 0.015, Logistic 0.681 ± 0.037.
All-predictors: Veg response RF AUC 0.646 ± 0.042, Logistic 0.642 ± 0.043.}%
  {RF and Logistic L2 compared across 4 predictor scenarios. All-predictors condition AUC: RF 0.730, Logistic 0.681.}
...
\figentry%
  ...
  {2026-03-15 18:00}%
  {Bar chart showing CV AUC before (all 8 predictors) and after RFECV selection for RF and Logistic.
Condition: RFECV selected 8 predictors. Veg response: RFECV selected 4 predictors.}%
  {RFECV reduces predictors (8 → 8 for condition, 4 for veg response) with minimal AUC change.}
...
Top RF predictors for Condition: FA_30_max, Shape_Leng, slope_200. Top RF predictors for Veg response: slope_200, Texture, Landform.}%
  {RF vs Logistic feature importance: top condition predictors are FA_30_max, Shape_Leng, slope_200; top veg response predictors are slope_200, Texture, Landform.}
