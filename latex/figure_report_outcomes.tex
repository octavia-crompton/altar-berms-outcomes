...
\figentry%
  ...
  {Panel A: both outcomes are predictable above chance, with structural condition (AUC=0.71) outperforming vegetation response (AUC=0.64). Panels B–C: the predictor rankings differ between outcomes — flow accumulation and berm length dominate condition prediction, while hillslope gradient and soil properties are more important for vegetation response.}
%% FIG_2_END
...
\figentry%
  {fig3}%
  {fig3_veg_response_by_condition_texture.png}%
  {2026-03-18 16:36}%
